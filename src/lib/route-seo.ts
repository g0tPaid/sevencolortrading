...
export const pages = {
  home: routeMetadata({
    ...
    description:
      "China sourcing agent with factories, 1688 buying into our Xiamen warehouse, Visit China, own 3PL in Xiamen and Dubai. No MOQ. Inspection USD 110/day.",
    path: "/",
  }),
  contact: routeMetadata({
    title: "China Factory Sourcing: No MOQ and Photo/Video QC",
    description:
      "China factory sourcing with no MOQ, start from 1 unit. Photo/video QC. Legal entity Xiamen Ajmal Seven Color Trading Co Ltd. DUNS 509419282.",
    path: "/contact",
  }),
  oemOdm: routeMetadata({
    title: "China OEM/ODM and New Product Development (NDA-First)",
    description:
      "OEM/ODM and new product development under NDA first. Concept, tooling, sampling, and mass production from the China desk. DUNS 509419282.",
    path: "/oem-odm",
  }),
  ...
  threePl: routeMetadata({
    ...
    description:
      "Own China 3PL from our Xiamen warehouse and Dubai / Al Ain hub, receive, store, pick, pack, and ship. Operator-owned, not a 3PL broker.",
    path: "/3pl",
  }),
  ...
  visit: routeMetadata({
    ...
    description:
      "Visit China factories from our Xiamen hub: airport pickup, verified lines, warehouse and QC, interpreter. Not a tourist tour.",
    path: "/visit",
  }),
  faq: routeMetadata({
  ...
  about: routeMetadata({
    title: "About Sourcing Center: China Sourcing Desk",
    description:
      "Xiamen Ajmal Seven Color Trading Co Ltd. DUNS 509419282. China hub warehouse in Xiamen and Dubai / Al Ain. Licenses listed.",
    path: "/about",
  }),
  ...
  compare: routeMetadata({
    ...
    description:
      "Sourcing agent vs Alibaba, China 3PL vs DIY freight, factory visit vs remote QC. Straight answers from the China desk.",
    path: "/compare",
  }),
  howItWorks: routeMetadata({
    title: "How China Factory Sourcing Works: RFQ to Delivery",
    description:
      "Four-step China sourcing: share requirements, source verified factories, photo/video QC, then ship. No MOQ. Own 3PL from Xiamen warehouse and Dubai.",
    path: "/how-it-works",
  }),
  ...
  factoryVerification: routeMetadata({
    ...
    description:
      "On-ground factory audits in China: license, production lines, capacity, and quality systems before you fund a PO.",
  ...
  sourcingForUae: routeMetadata({
    ...
    description:
      "China factory desk plus operator-owned UAE warehouse in Al Ain. Inspect in China, stage GCC stock in Dubai / Al Ain. License 143609.",
...
export const knowledgeMeta: Record<string, { title: string; description: string }> = {
  ...
  "china-sourcing-company-xiamen-dubai-3pl": {
    ...
    description:
      "Sourcing Center by Xiamen Ajmal Seven Color Trading Co Ltd. DUNS 509419282. China hub in Xiamen and Dubai warehouse. Sourcing plus 3PL desk.",
  },
...
export const compareMeta: Record<string, { title: string; description: string }> = {
  "sourcing-agent-vs-alibaba": {
    ...
    description:
      "Alibaba is a catalog. Sourcing Center is an on-ground China desk: verified factories, no MOQ, photo/video QC, own 3PL from Xiamen and Dubai.",
  },
