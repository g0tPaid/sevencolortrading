...
export const pages = {
  ...
  threePl: routeMetadata({
    title: "3PL Warehouses in Xiamen, China and Dubai / Al Ain",
    description:
      "Own 3PL warehouses in Xiamen and Dubai / Al Ain — receive, store, pick, pack, and ship. Operator-owned, not a 3PL broker. Legal entity since 2014.",
    path: "/3pl",
  }),
  dropshipping: routeMetadata({
    title: "Dropshipping from Our Own Xiamen and Dubai Warehouses",
    description:
      "Dropship single units from own warehouses in Xiamen and Dubai / Al Ain. Photo/video QC for DTC and marketplace sellers. Not a dropship broker.",
    path: "/dropshipping",
  }),
  logistics: routeMetadata({
    title: "Sea, Air, and Express Freight from China via Dubai",
    description:
      "Sea, air, and express freight from China after inbound to Xiamen or Dubai / Al Ain warehouses. Customs on the same desk as sourcing and 3PL.",
    path: "/logistics",
  }),
  visit: routeMetadata({
    title: "Hosted 3-Day Factory Visit Program in Xiamen, China",
    description:
      "Hosted 3-day factory visits in Xiamen: airport pickup, verified factories, HQ warehouse, interpreter. Not a tourist tour. Desk on the ground since 2014.",
    path: "/visit",
  }),
  faq: routeMetadata({
  ...
  about: routeMetadata({
    ...
    description:
      "Xiamen Ajmal Seven Color Trading Co Ltd has sourced from China since 2014. DUNS 509419282. Own warehouses in Xiamen and Dubai / Al Ain. Licenses listed.",
    path: "/about",
  }),
  ...
  knowledge: routeMetadata({
    ...
    description:
      "Field guides from Sourcing Center: how to source from China, inspection (PSI, DUPRO, AQL), own-warehouse 3PL, dropshipping, hosted Xiamen visits, RFQs.",
    path: "/knowledge",
  }),
  compare: routeMetadata({
    title: "Compare China Sourcing Agent, 3PL, and Factory Visits",
    description:
      "Sourcing agent vs Alibaba, China 3PL vs DIY freight, factory visit vs remote QC. Straight answers from the Xiamen desk — operating since 2014.",
    path: "/compare",
  }),
  howItWorks: routeMetadata({
    title: "How China Factory Sourcing Works — RFQ to Delivery",
    description:
      "Four-step China sourcing: share requirements, source verified factories, photo/video QC, then ship. No MOQ. Own 3PL in Xiamen and Dubai since 2014.",
    path: "/how-it-works",
  }),
  industries: routeMetadata({
    title: "China Sourcing for Retail, DTC, Fashion, and Industrial",
    description:
      "Playbooks for ecommerce, retail, hospitality, industrial, fashion, and construction buyers sourcing from China with QC and Xiamen/Dubai warehouses.",
    path: "/industries",
  }),
  factoryVerification: routeMetadata({
    title: "China Factory Verification: License and Capacity Audits",
    description:
      "On-ground factory audits in China: license, production lines, capacity, and quality systems before you fund a PO. Xiamen desk operating since 2014.",
  ...
  reviews: routeMetadata({
    ...
    description:
      "Anonymized buyer notes on sourcing.center — factory sourcing, Xiamen and Dubai 3PL, hosted visits. Ask the desk for references. No star ratings used.",
    path: "/reviews",
  }),
  caseStudies: routeMetadata({
    title: "China Sourcing Case Studies: Factory, 3PL, and Visits",
    description:
      "Example engagements: factory matching, own 3PL in Xiamen and Dubai, hosted QC visits. Conservative anonymized outcomes — not published client KPIs.",
    path: "/case-studies",
  }),
  updates: routeMetadata({
    title: "Sourcing Center Updates: Guides, Comparisons, Cases",
    description:
      "Dated notes from the Sourcing Center desk into knowledge guides, comparison pages, and case studies on China sourcing, 3PL, and factory visits.",
    path: "/updates",
  }),
  factoriesRegister: routeMetadata({
    title: "China Factory Vendor Registration (工厂入驻) in Xiamen",
    description:
...
export const knowledgeMeta: Record<string, { title: string; description: string }> = {
  "how-to-source-from-china": {
    ...
    description:
      "Define the product, find factories, sample, negotiate, inspect, ship, and receive. Marketplace vs desk table. No MOQ. Own 3PL in Xiamen and Dubai.",
  },
  ...
  "3pl-warehouses-xiamen-dubai": {
    ...
    description:
      "Own 3PL in Xiamen, China and Dubai / Al Ain, UAE. Receive, store, pick, pack, and ship on the same desk as factory sourcing. Not a 3PL broker.",
  },
  "china-sourcing-company-xiamen-dubai-3pl": {
    title: "China Sourcing Company with Own 3PL in Xiamen/Dubai",
    description:
      "Sourcing Center by Xiamen Ajmal Seven Color Trading Co Ltd. Founded 2014. DUNS 509419282. Own warehouses in Xiamen and Dubai. Sourcing plus 3PL desk.",
  },
  "dropshipping-from-china-own-warehouse": {
    title: "Dropshipping from China: Own Warehouse vs a Broker",
    description:
      "Dropship from stock in Sourcing Center own Xiamen and Dubai warehouses after China sourcing and photo/video QC. Not a dropship broker marketplace.",
  },
  "factory-visit-xiamen-hosted-sourcing-trip": {
    title: "Hosted Factory Visit in Xiamen: China Sourcing Trip",
    description:
      "3-day hosted factory visit from Xiamen HQ of Xiamen Ajmal Seven Color Trading Co Ltd: airport, verified factories, warehouse, interpreter, QC wrap.",
  },
  "china-3pl-vs-broker-vs-fba": {
    title: "China 3PL vs Broker vs FBA: Which Fits an Importer?",
    description:
      "Compare operator-owned China 3PL (Xiamen + Dubai) with 3PL brokers and Amazon FBA. Sourcing Center runs warehouses on the same desk as sourcing.",
  },
  "how-to-write-an-rfq": {
    title: "How to Write RFQs That Chinese Factories Will Answer",
    description:
      "RFQ fields factories respond to: specs, quantity, target price, photos, Incoterms. No-MOQ sampling from 1 unit via the Sourcing Center Xiamen desk.",
  },
...
export const compareMeta: Record<string, { title: string; description: string }> = {
  "sourcing-agent-vs-alibaba": {
    ...
    description:
      "Alibaba is a catalog. Sourcing Center is an on-ground desk: verified factories, no MOQ, photo/video QC, own 3PL in Xiamen and Dubai, visits since 2014.",
  },
  "china-3pl-vs-diy-freight": {
    title: "China 3PL vs DIY Freight: Warehouse or You Stitch It",
    description:
      "Own 3PL in Xiamen and Dubai / Al Ain versus booking factory, warehouse, and forwarder yourself. Operator Xiamen Ajmal Seven Color Trading Co Ltd.",
  },
  "factory-visit-vs-remote-qc": {
    title: "Factory Visit vs Remote QC: When to Walk the Floor",
    description:
      "Hosted 3-day Xiamen visit versus inspection at USD 110 per inspector day. Same desk for both. Photo/video is the report, not a remote-only check.",
  },
};
