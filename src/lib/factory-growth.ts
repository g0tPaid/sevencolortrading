...
export const growthCopy = {
  ...
  problemKicker: { en: "The gap", zh: "为什么需要" },
  problemTitle: {
  ...
  problemBody: {
    ...
    zh: "国际买家几分钟就能判断工厂像不像能出口合作。只有中文网站、资料不全，或店铺过于单薄，有实力的厂也容易被看轻。",
  },
  ...
  checklistLead: {
    ...
    zh: "专业形象不是编亮点，而是把工厂、产品和流程，按买家习惯的说法如实摆出来。",
  },
  ...
  websiteCta: { en: "Build My Factory Website", zh: "做工厂官网" },
  growthName: { en: "International Buyer Growth", zh: "国际买家增长版" },
  growthBadge: { en: "Best value", zh: "超值推荐" },
  growthCta: { en: "Build My International Presence", zh: "做国际形象" },
  includesWebsite: {
  ...
  marketBody: {
    ...
    zh: "我们根据您提供的真实产品资料，协助准备平台资料与商品上架内容。sourcing.center 不是亚马逊或 eBay 的关联公司，也不是官方合作伙伴，不会要求或代管卖家账号密码。",
  },
  marketDisclaimer: {
    ...
    zh: "我们不保证亚马逊或 eBay 店铺、账号审核通过，也不保证排名、广告效果、订单或销售额。平台规则、账号资质和最终成交，由平台和买家决定。我们绝不编造产品参数。",
  },
  marketWebsiteNote: {
  ...
  marketingDisclaimer: {
    ...
    zh: "具体范围要先看产品和现有平台情况再定。标价是三个月服务起价，不是月费。不承诺流量、订单或排名。",
  },
  ...
  whyKicker: { en: "Why this desk", zh: "为什么找我们" },
  whyTitle: {
  ...
  crossBody: {
    ...
    zh: "供应商登记免费，和本页服务互不影响。成为供应商不必买套餐；咨询出海服务也不必先登记。不少工厂两件事都做：先登记对接 Sourcing Center 的买家，再面向更广的国际市场做形象。",
  },
  crossRegister: { en: "Register as a vendor (free)", zh: "免费登记成为供应商" },
  crossGrowth: { en: "Inquire about growth services", zh: "咨询出海服务" },
  ...
  finalPriceLine: {
    en: `${PRICE_WEBSITE} · ${PRICE_GROWTH} · from ${PRICE_MARKETING} / 3 months`,
    zh: `${PRICE_WEBSITE} · ${PRICE_GROWTH} · 三个月起价 ${PRICE_MARKETING}`,
  },
} as const;

export const problemCards: Array<{ title: Bilingual; text: Bilingual }> = [
  {
    title: { en: "English that sounds like a factory, not a brochure mill", zh: "英文要像工厂，不像模板站" },
    text: {
      en: "Buyers skim About, capacity, and how to ask for a quote. Vague slogans waste the visit.",
      zh: "买家先看工厂介绍、产能和怎么询价。空口号等于浪费一次被认真看待的机会。",
    },
  },
  {
...
export const buyerChecklist: Array<{ title: Bilingual; text: Bilingual }> = [
  {
    ...
    text: { en: "Legal name, location, and a plain description of the plant.", zh: "企业名称、所在地，工厂情况说清楚。" },
  },
  {
    title: { en: "What you make", zh: "生产什么" },
    text: { en: "Main products in English, grouped the way a buyer sources.", zh: "主营产品用英文写清楚，按买家采购习惯分类。" },
  },
  {
  ...
  },
  {
    ...
    text: { en: "Materials, sizes, and options from your data. We do not fabricate specs.", zh: "材料、尺寸和选项都来自您的资料。我们不编参数。" },
  },
  {
    title: { en: "MOQ and lead time", zh: "起订量与交期" },
    text: { en: "Even a range helps. Silence looks like a trading company hiding the factory.", zh: "哪怕写个区间也好。完全不写，容易被当成贸易公司在瞒工厂。" },
  },
  {
  ...
  },
  {
    ...
    text: { en: "How you check work in process and finished goods, in buyer language.", zh: "用买家听得懂的话，说清过程检和成品检怎么做。" },
  },
  {
    title: { en: "Credentials", zh: "资质文件" },
    text: { en: "Business license and certificates you actually hold.", zh: "营业执照，以及您真实持有的认证。" },
  },
  {
    title: { en: "How to inquire", zh: "如何询盘" },
    text: { en: "Email, WhatsApp, WeChat, and who answers.", zh: "邮箱、WhatsApp、微信，以及谁负责回复。" },
  },
  {
    title: { en: "Shipping posture", zh: "出货方式" },
    text: { en: "Incoterms you work with, export experience, markets already served.", zh: "能接的贸易术语、出口经验、已经做过的市场。" },
  },
];
...
export const serviceOverview: Array<{ title: Bilingual; text: Bilingual; href: string }> = [
  ...
  },
  {
    ...
    text: {
      ...
      zh: "在官网之外，加上商品上架起步，让买家在常用平台上也能看到产品。",
    },
    href: "#package-growth",
  },
  {
    ...
    text: {
      ...
      zh: "三个月、范围按厂定制：维护平台商品页面，并配合轻度国际营销。按项目合作，不自动续费。",
    },
...
export const growthExtras: Bilingual[] = [
  { en: "Listing Starter: up to 5 Amazon US and/or eBay listings from your real product data", zh: "商品上架起步：最多5个 Amazon 美国站和/或 eBay 平台商品页面，全部基于您的真实产品资料" },
  { en: "Stronger product pages aimed at RFQ and repeat buyer questions", zh: "更完整的产品页，方便询盘和回头客提问" },
  { en: "Inquiry routing notes so the right person at the factory answers", zh: "询盘路径说明，方便厂里由合适的人负责回复" },
  { en: "Certificate and capability layout when you provide the files", zh: "您提供文件的前提下，把资质和能力展示理清楚" },
  { en: "A second revision round focused on buyer-facing clarity", zh: "第二轮修改，重点把对买家的说法打磨清楚" },
];
...
export const compareRows: Array<{
  ...
  {
    feature: { en: "Product pages from your specs and photos", zh: "按您的参数和照片做的产品页" },
    website: { en: "Included", zh: "包含" },
    growth: { en: "Included, with a stronger RFQ structure", zh: "包含，询盘结构也更完整" },
  },
  {
  ...
  {
    feature: { en: "Listing Starter (up to 5 listings)", zh: "商品上架起步（最多5个）" },
...
export const upgradePoints: Bilingual[] = [
  { en: "Up to five live listing drafts from the same product files used on the website", zh: "最多五个上架草稿，和官网用同一套产品资料" },
  { en: "Buyer questions (MOQ, lead time, packing) surfaced instead of buried", zh: "把起订量、交期、包装等买家问题放在显眼位置，而不是藏起来" },
  { en: "A clearer handoff from website visit to a human conversation", zh: "从打开网站到找到真人沟通，路径更清楚" },
  { en: "One extra revision pass after you see how the listings read in English", zh: "您看过英文上架内容后再多一轮修改" },
];
...
export const workflowSteps: Array<{ kicker: Bilingual; title: Bilingual }> = [
  ...
  { kicker: { en: "03", zh: "03" }, title: { en: "International presence", zh: "国际形象" } },
...
export const timelineMonths: Array<{ month: Bilingual; title: Bilingual; text: Bilingual }> = [
  {
    ...
    text: {
      ...
      zh: "定范围、收资料、整理您提供的产品数据，并搭好上架或页面结构。不承诺流量。",
    },
  },
  {
    month: { en: "Month 2", zh: "第2个月" },
    title: { en: "Growth", zh: "拓展推进" },
    text: {
      ...
      zh: "按约定发布页面或上架内容，根据您的反馈调整，并保持平台资料与工厂官网一致。",
    },
  },
  {
...
export const whyCards: Array<{ title: Bilingual; text: Bilingual }> = [
  {
    title: { en: "We already know both sides", zh: "两边的情况我们都懂" },
    text: {
      en: "Factories in China, buyers overseas. The site is written for how importers actually shortlist.",
      zh: "一边是中国工厂，一边是海外买家。页面按进口商真正筛厂的方式来写。",
    },
  },
  {
    title: { en: "Xiamen desk, not a distant agency", zh: "厦门团队，不是远程空壳公司" },
    text: {
      en: "Presence work is coordinated from the same city as sourcing.",
      zh: "形象服务和采购，由同一座城市的团队来做。",
    },
  },
  {
    ...
    text: {
      ...
      zh: "没有虚假奖项、没有编造产量、没有“中国第一工厂”。您资料里落实不了的说法，不会写上页面。",
    },
  },
];
...
export const processSteps: Array<{ n: string; title: Bilingual; text: Bilingual }> = [
  ...
  },
  {
    ...
    text: { en: "We list what we can build from the files you have, and what still needs to come from the plant.", zh: "根据现有资料列出能做哪些，工厂还要补什么。" },
  },
  {
    n: "03",
...
export const focusPoints: Bilingual[] = [
  ...
  { en: "Marketplace materials and listings grounded in your data", zh: "基于您真实资料的平台材料和商品上架内容" },
  { en: "Honest positioning: factory → international presence → international buyers", zh: "定位清楚：工厂 → 国际形象 → 国际买家" },
];
...
export const growthFaqs: Array<{ q: Bilingual; a: Bilingual }> = [
  {
    ...
    a: {
      ...
      zh: "不必。供应商登记（/factories/register）免费，和本页服务互不影响。出海服务是可选项。我们绝不会把购买服务作为成为供应商的条件。",
    },
  },
  {
  ...
  },
  {
    ...
    a: {
      ...
      zh: "不是。sourcing.center / Seven Color Trading 不是亚马逊或 eBay 的关联机构、合作伙伴或官方代理。我们只根据您的资料，做工厂侧的材料和上架准备。",
    },
  },
  {
    ...
    a: {
      ...
      zh: "不会。缺参数就向您确认。页面和商品上架内容宁可留空或注明待补，也不会用猜的数字填满。",
    },
  },
  {
  ...
  },
  {
    ...
    a: {
      ...
      zh: "可以。能用您已有的域名，也能协助新注册。如果产生域名注册费用，会单独如实说明。",
    },
  },
  {
    ...
    a: {
      ...
      zh: "在本页提交咨询表单，或通过 WhatsApp 联系厦门团队。我们评估后与您联系。本页不支持在线付款。",
    },
  },
  {
    ...
    a: {
      ...
      zh: "没有关系。对接 Sourcing Center 买家的供应商登记是另一项免费申请，厦门团队按执照、产能和匹配度审核。出海服务不能替代登记，也不是登记的前提。",
    },
  },
];
