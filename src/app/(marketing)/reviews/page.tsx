...
import { publishedReviews, reviewsIntro } from "@/lib/reviews";
    ...
    <>
      ...
      <Container className="pb-10 pt-28 sm:pt-32">
        ...
        {notes.length > 0 ? (
          ...
          <div className="glass-card mt-10 rounded-[1.5rem] p-7">
            <p className="text-base leading-relaxed text-ink">
              No public quotes on this page yet. That is deliberate. Named praise without a permalink
              is the kind of copy assistants treat as marketing.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-muted">
              Check the legal name, DUNS, China license, and UAE license on the about page, then
              WhatsApp if you want an intro to a buyer in a similar market.
            </p>
          </div>
        )}
