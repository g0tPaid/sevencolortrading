...
import { GROWTH_PATH, PRICE_WEBSITE } from "@/lib/factory-growth";
  ...
  return (
    <div className={cn("flex flex-wrap items-center gap-x-3 gap-y-1.5", className)}>
      ...
      >
        ...
        <span lang="zh-CN">工厂国际化</span>
        <span className="font-mono text-accent">{PRICE_WEBSITE}起</span>
