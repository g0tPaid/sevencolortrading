...
export function V2Ideation() {
  ...
  return (
    <section id="ideation" className="section-y scroll-mt-28">
      <Container>
        ...
        <div className="glass-chip mx-auto mt-10 flex max-w-md justify-center gap-1 rounded-full p-1.5">
          <button
            type="button"
            ...
            className={`inline-flex flex-1 items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold transition ${
              mode === "new" ? "bg-ink text-paper" : "text-muted hover:text-ink"
            }`}
          >
          ...
          <button
            ...
            className={`inline-flex flex-1 items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold transition ${
              mode === "catalog" ? "bg-ink text-paper" : "text-muted hover:text-ink"
            }`}
          >
        ...
        <div id="new-idea" className="mx-auto mt-10 max-w-3xl scroll-mt-28">
          <div className="glass-panel rounded-[1.75rem] p-5 sm:p-7">
            ...
            <textarea
              ...
              className="glass-input mt-2 w-full resize-none rounded-2xl px-4 py-3 text-ink outline-none"
            />
            {error ? (
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Link
                href="/contact"
                className="glass-chip inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold text-ink"
              >
        ...
        {mode === "new" ? (
          <div className="mx-auto mt-10 max-w-5xl sm:mt-14">
            ...
            <ol className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {ideaPathSteps.map((step, i) => (
                <motion.li
                  ...
                  className="glass-card rounded-[1.35rem] p-5"
                >
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                href="/contact"
                className="inline-flex rounded-full bg-ink px-6 py-3 text-sm font-semibold text-paper"
              >
