...
export function V2Dropshipping() {
  return (
    <section
      id="dropshipping"
      aria-labelledby="dropshipping-heading"
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-accent/40 bg-ink px-5 pb-12 pt-16 text-paper shadow-[0_24px_80px_rgba(214,0,0,0.18)] sm:px-10 sm:pb-16 sm:pt-20 lg:px-14">
          ...
          <div className="relative">
            <p className="text-sm font-medium uppercase tracking-[0.22em] text-paper/55">
              DTC &amp; Amazon sellers · own warehouses · not a broker
            </p>
            <h2 id="dropshipping-heading" className="mt-3 max-w-4xl">
            ...
            <p className="mt-4 max-w-2xl text-paper/70 sm:text-lg">{dropshipping.description}</p>

            <div className="mt-8 flex gap-2 overflow-x-auto pb-2">
              {dropshippingSteps.map((step, i) => (
                <motion.div
                  key={step.title}
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              {dropshippingBenefits.map((hub, i) => (
                <motion.div
                  key={hub.city}
                  initial={{ opacity: 0, y: 18 }}
                  whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="mt-10">
              <h3 className="font-display text-2xl font-semibold text-paper">
                Dropship questions sellers ask
              </h3>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                ...
                Dropshipping from our warehouses
